      ...
      <div className="card-body">
        <div className="row align-items-center">
          <div className="col-12 col-md-12 col-lg-5 order-2 order-md-1">
            ...
            <img class="img-fluid img-bordered img-rounded" src="assets/img/photo2.png" alt="Photo" />
          </div>

          <div className="col-12 col-md-12 col-lg-7 order-1 order-md-2">
            <p>Für Bewerber:innen</p>
            <h3 className="text-primary">Erfahren Sie von geeigneten Stellen, ohne danach zu suchen.</h3>
            <p className="text-muted">worknet ag hilft Dir dabei…</p>
            <br />

            <ul className="list-unstyled">
              <li>
                <i class="fas fa-fw fa-check-circle"></i> Jobs zu finden, die zu Ihren Erfahrungen, Wünschen und Gehaltsvorstellungen passen
              </li>
              <li>
                <i class="fas fa-fw fa-check-circle"></i> Mit Unternehmen in Kontakt zu kommen, die aktiv nach neuen Mitarbeiter:innen suchen - und nur darauf warten, Sie kennenzulernen
              </li>
              <li>
                <i class="fas fa-fw fa-check-circle"></i> Bei der Neuausrichtung im beruflichen Leben. Für eine individuelle Newplacement Lösung freuen wir uns auf Ihre Kontaktaufnahme.
              </li>

            </ul>
            <div className="text-center mt-5 mb-3">
              <a href="#" className="btn btn-sm btn-primary mr-1">Kontakt</a>
            </div>
          </div>
        </div>
      </div>
