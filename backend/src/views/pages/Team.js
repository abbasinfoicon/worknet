              ...
              <div className="card-body pt-0">
                <div className="row">
                  ...
                  <div className="col-5 text-center">
                    <img src="assets/img/user1-128x128.jpg" alt="user-avatar" className="img-circle img-fluid" />
                  </div>
                </div>
              </div>
            ...
            <div className="card bg-light d-flex flex-fill">
              ...
              <div className="card-body pt-0">
                <div className="row">
                  ...
                  <div className="col-5 text-center">
                    <img src="assets/img/user2-160x160.jpg" alt="user-avatar" className="img-circle img-fluid" />
                  </div>
                </div>
              </div>
              <div className="card-footer">
